...
schedule_stock_dict = {}# { full_code: { [direction: sell, buy]: { max_allow_amo, single_order_amo, single_order_percent, monitor_signal:['static(sync order)', 'signal_lidu', 'confirm_on_up'] }}}
